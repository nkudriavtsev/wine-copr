...
Source0:        http://downloads.sourceforge.net/wine/wine-%{version}-rc6.tar.bz2
...
Source900: https://github.com/compholio/wine-compholio/archive/v%{version}.tar.gz#/wine-staging-%{version}-rc6.tar.gz
