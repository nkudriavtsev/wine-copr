...
%endif
%if %[ 0%{?fedora} && !( "x86_64" == "%{_target_cpu}" && %{with new_wow64} ) ]
...
%ifarch x86_64 aarch64
%if %[ "aarch64" == "%{_target_cpu}" || ( "x86_64" == "%{_target_cpu}" && %{with new_wow64} ) ]
...
%if 0%{?wine_staging}
%{_libdir}/wine/%{winepedirs}/windows.networking.connectivity
%endif
...
%changelog
* Sat Mar 16 2024 Teoh Han Hui <teohhanhui@gmail.com> - 9.5-2
